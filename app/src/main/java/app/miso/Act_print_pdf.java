...
public class Act_print_pdf extends Activity implements View.OnClickListener {
    String kode_stok;
    Button btn_main,btn_ref;
    TextView tx_user;
    WebView myWebView;
    WebView printWeb;
    String user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lay_print_pdf);
...
//            myWebView.loadUrl(url_print);
            ...
            if (myWebView != null) {
                ...
                //    PrintTheWebPage(myWebView);
                    ...
                    Toast.makeText(Act_print_pdf.this, "Not available for device below Android LOLLIPOP", Toast.LENGTH_SHORT).show();
                }
            } else {
                // Showing Toast message to user
                Toast.makeText(Act_print_pdf.this, "WebPage not fully loaded", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public void dd_kembali(){
        Intent i = new Intent(Act_print_pdf.this,Act_utama.class);
        finish();
        startActivity(i);
    }
